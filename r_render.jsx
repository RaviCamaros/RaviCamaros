...
var seedloop = typeDropDown.selection.text;
...
rendercommand.size = [100,30]


//------------------------------------------------------------

var panelFormat = mainWindow.add("panel", undefined, "Set Render Queue");
panelFormat.orientation = "column";

var panelOneGroupOpt = panelFormat.add("group", undefined, "panelOneGroupOpt");
panelOneGroupOpt.orientation = "row";
panelOneGroupOpt.add("statictext", undefined, "Fomat:");

var FormatOpt = panelOneGroupOpt.add("dropdownlist", undefined, ["EXR", "EXR_RGBA", "Tiff", "Tiff_RGBA", "MOV"]);
FormatOpt.selection = 0;

var buttonQueueFormat = panelOneGroupOpt.add("button", undefined, "Add Render Queue");
    
buttonQueueFormat.onClick = function (){
...
function amerender(){
   ...
   var comp = app.project.activeItem;
     var RFormat = FormatOpt.selection.text;
var item = app.project.renderQueue.items.add(comp);
var outputModule = item.outputModule(1);

//var outputFolder = "~/Desktop";

outputModule.applyTemplate(RFormat);
...
//var buttonQueueFormat = panelOneGroupOpt.add("button", undefined, "AME");
...
buttonScript.onClick = function Render()
{
  ...
  //  {
   ...
   // }
    ...
    var buttonCancel = panelThreeGroupOne.add("button", undefined, "Cancel");
